...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("point (0, 0) compared to point (0, 1) " + p1.compareTo(p2));
        StdOut.println("point (0, 1) compared to point (0, 1) " + p2.compareTo(p3));
        StdOut.println("point (1, 1) compared to point (0, 1) " + p4.compareTo(p2));
        StdOut.println("slope from (0, 0) to (0, 1): " + p1.slopeTo(p2));
        StdOut.println("slope from (0, 0) to (1, 1): " + p1.slopeTo(p4));
        StdOut.println("slope from (0, 1) to (0, 1): " + p2.slopeTo(p3));
        StdOut.println("slope from (0, 3) to (1, 1): " + p5.slopeTo(p4));
        Comparator<Point> comp = p1.slopeOrder();
        StdOut.println("slope comparator, (0, 0) to (1, 1) and (0, 3): " + comp.compare(p4, p5));
        StdOut.println("slope comparator, (0, 0) to (0, 1) and (0, 1): " + comp.compare(p2, p3));
        StdOut.println("slope comparator, (0, 0) to (0, 1) and (1, 1): " + comp.compare(p2, p4));
        StdOut.println("point get class " + p4.getClass());
        StdOut.println("point class == Point " + p4.getClass().equals(Point.class));
    }
}
